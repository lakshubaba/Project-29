...
function setup()
{
    ...
    //level 1
    box1 = new Box(580, 580, 40, 60);
    box2 = new Box(620, 580, 40, 60);
    box3 = new Box(660, 580, 40, 60);
    box4 = new Box(700, 580, 40, 60);
    box5 = new Box(740, 580, 40, 60);
    box6 = new Box(780, 580, 40, 60);
    box7 = new Box(820, 580, 40, 60);

    //level 2
    box8 = new Box(620, 520, 40, 60);
    box9 = new Box(660, 520, 40, 60);
    box10 = new Box(700, 520, 40, 60);
    box11 = new Box(740, 520, 40, 60);
    box12 = new Box(780, 520, 40, 60);

    //level 3
    box13 = new Box(660, 460, 40, 60);
    box14 = new Box(700, 460, 40, 60);
    box15 = new Box(740, 460, 40, 60);

    //level 4
    box16 = new Box(700, 400, 40, 60);
